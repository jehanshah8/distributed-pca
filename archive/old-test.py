...
import src.distributed_pca as distributed_pca
...
if __name__ == '__main__':
    ...
    for i in range(n_nodes - n_mal_nodes):
        nodes.append(distributed_pca.LocalPCA(n_components=n_components))

    for i in range(n_mal_nodes): 
        nodes.append(distributed_pca.MalLocalPCA(n_components=n_components))
